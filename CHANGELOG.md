...
- **The PR detail rail now carries reviewers, assignees, labels and worktree.** Labels keep GitHub's own colour. The worktree line answers what no GitHub field can: whether a worktree here has this PR's branch checked out, and whether it is clean. (ADR-0200)
