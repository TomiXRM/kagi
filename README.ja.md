...
| Linux(x86_64)| `kagi-<version>-x86_64.tar.gz`(バイナリ + `.desktop` + アイコン)|
...
タグ `v*` を push すると [release workflow](.github/workflows/release.yml) が macOS arm64 / x86_64 + Linux x86_64 をビルドし、checksum 付きで draft release に上げます。
