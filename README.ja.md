...
<div align="center">
<img src="docs/images/analyze.png" width="900" alt="Analyze ビュー。churn × サイズ でリスク順に並べた Hotspots のリスト、期間セレクタ、List / Map 切り替え、Hotspots / Coupling / Ownership モード、Copy diagnostic アクション" />
</div>
