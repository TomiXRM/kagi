...
pub use ops::{
    ...
    plan_merge_branch, plan_merge_into_branch, plan_open_worktree_for_branch, plan_pull,
    ...
    AmendMode, AmendOutcome, BranchRenameValidation, DiscardBackup, DiscardOutcome, FetchOutcome,
    HistoryMoveOutcome, MergeIntoKind, MergeKind, OperationPlan, PullOutcome, PushOutcome,
    StateSummary, UndoOutcome,
};
#[allow(unused_imports)]
