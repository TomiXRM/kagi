...
impl Msg {
    ...
    pub fn t(self) -> &'static str {
        ...
        match (lang(), self) {
            ...
            (En, IssuesNone) => "None",
            (Ja, IssuesNone) => "なし",
            (En, IssueMetadata) => "Issue metadata",
            (Ja, IssueMetadata) => "Issue メタデータ",
            (En, IssueFieldState) => "State",
            (Ja, IssueFieldState) => "状態",
            (En, IssueFieldAuthor) => "Author",
            (Ja, IssueFieldAuthor) => "作成者",
            (En, IssueFieldLabels) => "Labels",
            (Ja, IssueFieldLabels) => "ラベル",
            (En, IssueFieldAssignees) => "Assignees",
            (Ja, IssueFieldAssignees) => "担当者",
            (En, IssueFieldCreated) => "Created",
            (Ja, IssueFieldCreated) => "作成日",
            (En, IssueFieldUpdated) => "Updated",
            (Ja, IssueFieldUpdated) => "更新日",
            (En, PrAllPrs) => "All PRs",
            (Ja, PrAllPrs) => "PR 一覧",
            (En, PrStack) => "STACK",
            (Ja, PrStack) => "スタック",
