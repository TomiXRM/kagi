...
impl Msg {
    ...
    pub fn t(self) -> &'static str {
        ...
        match (lang(), self) {
            ...
            (Ja, BcmOnlyFromCurrentBranch) => "現在のブランチからのみ実行できます",
            ...
            (Ja, CleanupDeleteSelected) => "選択したブランチを削除",
