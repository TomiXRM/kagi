...
- added `src/ui/branch_menu.rs` with branch menu state, header rendering, and overlay rendering.
- backdrop and menu card both call `.occlude()` to avoid click-through.
