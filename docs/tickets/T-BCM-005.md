...
- added `BranchMenuContext` and pure `branch_context_menu_items` in `src/ui/branch_menu.rs`.
- app code precomputes context from existing snapshot-derived UI state before rendering.
