...
- `Reveal branch HEAD in graph` dispatches through the existing `jump_to_commit` path.
- right-click selection also uses existing branch/commit jump helpers before opening the menu.
