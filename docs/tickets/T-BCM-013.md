...
- local `Checkout` dispatches to the existing `open_plan_modal` checkout flow.
- current branch and busy state are disabled in availability; remote checkout/tracking remains a disabled remote-op stub because this lane does not add git operations.
