...
pub enum Msg {
    ...
    ConflictMarkSelectedResolved,
    ConflictMarkAllCleanResolved,
...
impl Msg {
    ...
    pub fn t(self) -> &'static str {
        ...
        match (lang(), self) {
            ...
            (En, EditorEditResult) => "Edit result",
            (Ja, EditorEditResult) => "結果を編集",
            (En, EditorResetHunk) => "Reset this hunk",
            (Ja, EditorResetHunk) => "この hunk をリセット",
            (En, EditorHunkUnresolved) => "unresolved hunk",
            (Ja, EditorHunkUnresolved) => "未解決の hunk",
            (En, EditorBackToList) => "‹ Back to conflict list",
            (Ja, EditorBackToList) => "‹ 衝突一覧へ戻る",
            ...
            (En, EditorOriginContext) => "context",
            (Ja, EditorOriginContext) => "共通",
            (En, EditorOriginCurrent) => "current",
            (Ja, EditorOriginCurrent) => "現在",
            (En, EditorOriginIncoming) => "incoming",
            (Ja, EditorOriginIncoming) => "取込",
            (En, EditorOriginManual) => "manual",
            (Ja, EditorOriginManual) => "手編集",
            ...
            (En, ConflictViewPath) => "Path",
            (Ja, ConflictViewPath) => "パス",
            (En, ConflictViewTree) => "Tree",
            (Ja, ConflictViewTree) => "ツリー",
            (En, ConflictTreeSoon) => "Tree view is coming in v0.2.",
            (Ja, ConflictTreeSoon) => "ツリー表示は v0.2 で対応予定です。",
            ...
            (En, ConflictMarkSelectedResolved) => "Mark selected file resolved",
            (Ja, ConflictMarkSelectedResolved) => "選択ファイルを解決済みにする",
            (En, ConflictMarkAllCleanResolved) => "Mark all clean files resolved",
            (Ja, ConflictMarkAllCleanResolved) => "marker の無いファイルを一括解決済みにする",
